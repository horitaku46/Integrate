...
{
  dataR_max = CARIBARATION_R_MAX;
  dataG_max = CARIBARATION_G_MAX;
  dataB_max = CARIBARATION_B_MAX;
  dataR_min = CARIBARATION_R_MIN;
  dataG_min = CARIBARATION_G_MIN;
  dataB_min = CARIBARATION_B_MIN;
}
...
void readRGB()
{
  ...
  /*Serial.print( "RGB = " );
  Serial.println();
  Serial.println(red_G); Serial.print(",");
  Serial.println(green_G); Serial.print(",");
