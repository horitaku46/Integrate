...
{
  compass.m_max.x = CARIBARATION_COMPASS_MAX_X;
  compass.m_max.y = CARIBARATION_COMPASS_MAX_Y;
  compass.m_min.x = CARIBARATION_COMPASS_MIN_X;
  compass.m_min.y = CARIBARATION_COMPASS_MIN_Y;
}
